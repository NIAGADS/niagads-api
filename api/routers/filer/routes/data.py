...
@router.get("/", tags=tags,
    ...
    response_model=Union[BEDResponse, PagedResponseModel, FILERTrackSummaryResponse, TableViewResponseModel],
...
) -> Union[BEDResponse, PagedResponseModel, FILERTrackSummaryResponse, TableViewResponseModel]:
...
@router.get("/search", tags=tags, 
    response_model=Union[PagedResponseModel, FILERTrackSummaryResponse, BEDResponse, TableViewResponseModel],
...
async def get_track_data_by_metadata_search(
    ...
    view: str = Query(ResponseView.DEFAULT, description=ResponseView.get_description()),
    internal: InternalRequestParameters = Depends(),
) -> Union[PagedResponseModel, FILERTrackSummaryResponse, BEDResponse, TableViewResponseModel]:

...
| record        | Data Retrieval            | Retrieve entity nomenclature, metadata, data, or annotations by ID           |
...
{/* | reference     | Search and Data Retrieval | Search and retrieve from third party reference data (e.g., pathways by keyword) | - */}

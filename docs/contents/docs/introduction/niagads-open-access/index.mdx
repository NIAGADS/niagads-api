...
<Note title="Coming soon - Ask NIAGADS Open Access" type="success">
We’re building a natural-language planner to help AD researchers explore genetic evidence across 
NIAGADS Open Access resources—starting from a question, not a query form.

Check back in mid-June as we introduce new query enpoints and interfaces.

<a href="https://forms.gle/fbBY6wngCmJrNKdC7">Register as a beta tester</a> to help shape what comes next.
...
some endpoints may change, be unstable, or temporarily break.
</Note>
